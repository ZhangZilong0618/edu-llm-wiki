...
from routes import chat, conversations, graph, ingest, materials_graph, projects, research, search, settings_api, tests, wiki
...
app.include_router(materials_graph.router)
